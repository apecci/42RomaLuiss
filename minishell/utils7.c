...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/23 15:42:28 by apecci            #+#    #+#             */
/*   Updated: 2022/03/23 15:42:29 by apecci           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_freemem(char **matrix, int max)
{
	int	i;
...
static int	ft_cutter(char **res, char *bck, char c)
{
	int	i;
	int	slen;
